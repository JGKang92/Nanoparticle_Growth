function [mean_theory, var_theory, totmdata] = Calculate_Mean_Var_In_situ(x, expdata, options) % See Method Derivation of eq 2 for detail
    ...
    for idx = 1:lent
        ...
        nval = nval(~isnan(nval)); % remove nan in nval
